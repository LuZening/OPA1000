...
#define OV7670_HREF_BIT     GPIO_Pin_14//GPIO_Pin_15//PC5
#define OV7670_VSYNC_BIT    GPIO_Pin_13//GPIO_Pin_14//PC4

#define HREF_H		 GPIO_SetBits(GPIOA,GPIO_Pin_14); //GPIO_Pin_15
#define HREF_L		 GPIO_ResetBits(GPIOA,GPIO_Pin_14); //GPIO_Pin_15
...
*/
  #define GPIO_VSYNC_CMOS                    GPIOA
  #define RCC_APB2Periph_GPIO_VSYNC_CMOS     RCC_APB2Periph_GPIOA
  #define GPIO_PIN_VSYNC_CMOS                GPIO_Pin_13//GPIO_Pin_14
  #define EXTI_LINE_VSYNC_CMOS               EXTI_Line13//EXTI_Line14
  #define GPIO_PORT_SOURCE_VSYNC_CMOS        GPIO_PortSourceGPIOA
  #define GPIO_PIN_SOURCE_VSYNC_CMOS         GPIO_PinSource13

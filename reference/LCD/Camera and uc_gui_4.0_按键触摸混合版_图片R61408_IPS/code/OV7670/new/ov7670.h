...
#define OV7670_HREF_BIT     GPIO_Pin_8//GPIO_Pin_15//PC5
#define OV7670_VSYNC_BIT    GPIO_Pin_15//GPIO_Pin_14//PC4

#define HREF_H		 GPIO_SetBits(GPIOC,GPIO_Pin_8); //GPIO_Pin_15
#define HREF_L		 GPIO_ResetBits(GPIOC,GPIO_Pin_8); //GPIO_Pin_15
...
*/
  ...
  #define GPIO_PIN_VSYNC_CMOS                GPIO_Pin_15//GPIO_Pin_14
  #define EXTI_LINE_VSYNC_CMOS               EXTI_Line15//EXTI_Line14
  #define GPIO_PORT_SOURCE_VSYNC_CMOS        GPIO_PortSourceGPIOC
  #define GPIO_PIN_SOURCE_VSYNC_CMOS         GPIO_PinSource15//GPIO_PinSource14

...
{ 
	...
	/*所有Lcd引脚配置为推挽输出*/
	/*16位数据低8位*/
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2|GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15;
  ...
  ******************************/
  ...
  for(i=50000;i>0;i--);
	...
	if(DeviceCode==0x9325||DeviceCode==0x9328)
	{
        ...
        ili9320_WriteRegister(0x0003,(1<<12)|(1<<5)|(1<<4)|(1<<3)|(1<<0) ); 	//65K 
...
void ili9320_SetCursor(u16 x,u16 y)
{
	...
	else
	{
		...
		ili9320_WriteRegister(0x0020,240-y); // 行

...
u16 ili9320_GUI_Color565(u32 RGB);  // RGB颜色转为16位(565)

void ili9320_GUI_Text(u16 x, u16 y, u8 *str, u16 len,u16 Color, u16 bkColor);
void ili9320_GUI_Line(u16 x0, u16 y0, u16 x1, u16 y1,u16 color);  // 画线
void ili9320_GUI_Circle(u16 cx,u16 cy,u16 r,u16 color,u8 fill);  // 画园
void ili9320_GUI_Rectangle(u16 x0, u16 y0, u16 x1, u16 y1,u16 color,u8 fill); // 画矩形
void ili9320_GUI_Square(u16 x0, u16 y0, u16 with, u16 color,u8 fill);  // 画正方形

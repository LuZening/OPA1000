...
#line 2 "..\\code\\RTC\\calendar.c"
#line 3 "..\\code\\RTC\\calendar.c"
...
u8 const *sky[10]=  {"º◊","““","±˚","∂°","ŒÏ","º∫","∏˝","–¡","»…","πÔ",};
u8 const *earth[12]={"◊”","≥Û","“˙","√Æ","≥Ω","À»","ŒÁ","Œ¥","…Í","”œ","–Á","∫•",};
u8 const *monthcode[12]={"“ª","∂˛","»˝","Àƒ","ŒÂ","¡˘","∆ﬂ","∞À","æ≈"," Æ","∂¨","¿∞",};
u8 const *nongliday[4]={"≥ı"," Æ","ÿ•","»˝",};
...
{	
	...
	{	
		...
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<16;        
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR&=~(1<<16);     
				 
	    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<0;         
	    while(!(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR&0X02));
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<8; 
		((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR|=1<<15;

		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->PRLH=0X0000;
		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->PRLL=32770;          
	  	while(!(((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL&(1<<5)));
											   
		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL|=1<<4;   
		rtc_set(2009,4,19,23,59,55);
		((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL&=~(1<<4);
		while(!(((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRL&(1<<5)));
		temp|=0x02;
...
u8 GetJieQi(u16 year,u8 month,u8 day,u8 *JQdate)
{
	...
	bak1=YearMonthBit[(year-2000)*3+JQ/8];          
	value =((bak1<<(JQ%8))&0x80);                   

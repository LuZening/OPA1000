#line 1 "..\\code\\OV7670\\OV7670_test.c"
...
#line 3 "..\\code\\OV7670\\OV7670_test.c"
...
#line 4 "..\\code\\OV7670\\OV7670_test.c"
...
#line 5 "..\\code\\OV7670\\OV7670_test.c"
#line 1 "..\\code\\OV7670\\fifo.h"
...
#line 6 "..\\code\\OV7670\\OV7670_test.c"
#line 1 "..\\code\\OV7670\\ov7670.h"




#line 1 "..\\code\\OV7670\\SCCB.h"
...
#line 7 "..\\code\\OV7670\\OV7670_test.c"
...
#line 8 "..\\code\\OV7670\\OV7670_test.c"
...
#line 9 "..\\code\\OV7670\\OV7670_test.c"
...
#line 10 "..\\code\\OV7670\\OV7670_test.c"
...
#line 11 "..\\code\\OV7670\\OV7670_test.c"
...
#line 12 "..\\code\\OV7670\\OV7670_test.c"
...
extern void LCD_picture_start(void);
...
typedef __packed struct
{
	...
	u16 pic_nc1;				    
	u16 pic_nc2;				    
	u16 pic_data_address_l;	    
	u16 pic_data_address_h;		
	u16 pic_message_head_len_l;	
	u16 pic_message_head_len_h;	
	u16 pic_w_l;					
	u16 pic_w_h;				    
	u16 pic_h_l;				    
	u16 pic_h_h;				    
	...
	u16 pic_dipy_l;			    
	u16 pic_dipy_h;			    
	u16 pic_color_index_l;	    
	u16 pic_color_index_h;	    
	u16 pic_other_l;			    
	u16 pic_other_h;			    
	u16 pic_color_p01;		    
	u16 pic_color_p02;		    
...
void OV7670_main(void)
{
  ...
  GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x4000));;
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0010);
  ...
  Del_oneWeekAgo();
  pic_counter=get_record();
  while(lock_0)
  { 


    while(OV7670_Done_FLAG==0);
    
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR &= ~((uint32_t)0x02000);
		  

    
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0400);		    
	    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0200);
		  ...
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0200);((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0400);
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0200);
	...
	if(x!=800&&y!=800)
	{
		 ...
		 time_counter=0;
	  	 ...
	  	 re=IsPressed(x, y,280,200,40,40,&home);
		 if(re==3&&light_lock==0)
         {
					lock_0=0;
         }
         ...
         {
	         re=IsPressed(x, y,280,0,40,40,&book);
       ...
       if(x<200)
	    ...
	    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0200);
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0200);
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0200);
			((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0400);
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0200);
       ...
       {   		  
		  LCD_Scan_Set(2);		  
      LCD_GPIO_INPUT();
		  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0010);
     ...
     while(OV7670_Done_FLAG==0);
     GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x4000));;
	   ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0008);
	   OV7670_Done_FLAG=0;
  }
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR &= ~((uint32_t)0x02000);
  GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x4000));;
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0010);
  RCC_MCOConfig(((uint8_t)0x00));
...
{ 
  ...
  res = f_write(&fdst, bmpheader, 54, &bw);
  ...
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0010); 
	 ...
	 for (ty = 0; ty < 240; ty++)
     {
          ...
          { 	     	  		       
		   ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0200);	
		   ReadValue = ((GPIO_ReadInputData(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))))&0XFF00);	   
		   ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0200);

		   ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0200);
		   ReadValue |= ((GPIO_ReadInputData(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)))>>8)&0X00FF);	   
		   ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0200); 
...
static void record(void)
{
	...
	res = f_open(&record_dat,"record.dat", 0x08 | 0x02); 
    if(res==FR_OK){
		temp.i=pic_counter;
...
static unsigned int get_record(void)
{
    ...
    res = f_open(&record_dat, "record.dat", 0x00 | 0x01);	 
    if(res!=FR_OK){
        f_close(&record_dat);
	   	res = f_open(&record_dat,"record.dat", 0x08 | 0x02); 
        if(res==FR_OK){
...
void LCD_GPIO_OUTPUT(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin =  ((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000);

...
#line 34 "..\\code\\driver\\msd.c"


extern vu8 SD_Card_Ready;
...
void MSD_WriteByte(u8 Data)
{
	...
	while((((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->SR&1<<1)==0);
	((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR=Data;	 	    

#line 148 "..\\code\\driver\\msd.c"
}
...
{
	while((((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->SR&1<<1)==0);
	((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR=0xFF;	 	    
	while((((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->SR&1<<0)==0);
	return ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))->DR;          

#line 181 "..\\code\\driver\\msd.c"
}
...
u8 MSD_WriteBlock(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
  ...
  GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0001));
   
  MSD_SendCmd(24, WriteAddr, 0xFF);

   
  if (!MSD_GetResponse(0x00))
  {
...
u8 MSD_ReadBlock(u8* pBuffer, u32 ReadAddr, u16 NumByteToRead)
{
  ...
  MSD_SendCmd(17, ReadAddr, 0xFF);

   
  if (!MSD_GetResponse(0x00))
  {
     
    if (!MSD_GetResponse(0xFE))
    {
...
u8 MSD_WriteBuffer(u8* pBuffer, u32 WriteAddr, u32 NumByteToWrite)
{
  ...
  while (NbrOfBlock --)
  {
    ...
    MSD_SendCmd(24, WriteAddr + Offset, 0xFF);
...
u8 MSD_ReadBuffer(u8* pBuffer, u32 ReadAddr, u32 NumByteToRead)
{
  ...
  while (NbrOfBlock --)
  {
    ...
    MSD_SendCmd (17, ReadAddr + Offset, 0xFF);
...
u8 SDHC_Init(void)
{
    ...
    if(r1 == 0x05)
    {
        ...
        do
        {
            ...
            r1 = SD_SendCommand(55, 0, 0);
            if(r1 != 0x01)return r1;	  
            
            r1 = SD_SendCommand(41, 0, 0);
            retry++;
        }while((r1!=0x00) && (retry<60));
		...
		r1 = SD_SendCommand(59, 0, 0x95);
        if(r1 != 0x00)return r1;  
        
        r1 = SD_SendCommand(16, 512, 0x95);
        if(r1 != 0x00)return r1;
    ...
    else if(r1 == 0x01)
    {
        ...
        {	  
    		...
    		do
    		{
    			r1 = SD_SendCommand(55, 0, 0);
    			if(r1!=0x01)return r1;	   
    			r1 = SD_SendCommand(41, 0x40000000, 0);
                if(retry>60)return r1;  
            }while(r1!=0);		  
            
            
            r1 = SD_SendCommand_NoDeassert(58, 0, 0);
            if(r1!=0x00)return r1;  

...
void  FIFO_Set_GPIO_Config(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin =((uint16_t)0x0200)|((uint16_t)0x0008)|((uint16_t)0x0400)|((uint16_t)0x0010);                               
...
void  FIFO_Set_GPIO_Config_END(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000004), ENABLE);
  GPIO_InitStructure.GPIO_Pin =((uint16_t)0x0200)|((uint16_t)0x0008)|((uint16_t)0x0400);

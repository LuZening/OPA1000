...
void Touch_GPIO_Config(void) 
{
    ...
    GPIO_InitStructure.GPIO_Pin=((uint16_t)0x2000)|((uint16_t)0x8000)|((uint16_t)0x1000);
...
static void WR_CMD (unsigned char cmd) 
{
    ...
    if (0) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x8000)); else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x8000));
    if (0) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x2000)); else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x2000));

    for(i=0;i<8;i++) 
    {
        buf=(cmd>>(7-i))&0x1;
        if (buf) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x8000)); else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x8000));
        
        if (1) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x2000)); else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x2000));
...
static unsigned short RD_AD(void) 
{
    ...
    {
        if (0) GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x2000)); else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x2000));          
        temp= (GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x4000))) ? 1:0;
        buf|=(temp<<(11-i));
...
char IsPressed(u16 x, u16 y,u16 x0, u16 y0, u16 lenth, u16 width,char* pressed)
{
  ...
  if(x>x0&&x<x0+lenth){
	 if(y>y0&&y<y0+width){
		 ...
		 if(*pressed==0){
		   	virtual_LCM_Rectangle_V2(x0, y0,lenth,width,0x001F,0); 
			*pressed=1;
		  }

	  }else if(*pressed==1){
	   	 virtual_LCM_Rectangle_V2(x0, y0,lenth,width,0x7BEF,0); 
		 *pressed=0;
	  }
  }else if(*pressed==1){
	  virtual_LCM_Rectangle_V2(x0, y0,lenth,width,0x7BEF,0); 
...
char IsPressed_V2(u16 x, u16 y,u16 x0, u16 y0, u16 lenth, u16 width,char* pressed)
{
  ...
  if(state==1&&Newstate==1){
      virtual_LCM_Rectangle_V2(x0, y0,20,20,0x001F,0); 
...
char IsPressed_V3(u16 x, u16 y,u16 x0, u16 y0, u16 lenth, u16 width,char* pressed)
{
  ...
  if(state==1&&Newstate==1){
      virtual_LCM_Rectangle_V2(x0-1, y0-1,lenth+1,width+1,0x001F,0); 

...
char Tiky_Button(char *filename,u16 x,u16 y)
{
  ...
  res = f_open(&fsrc, filename, 0x00 | 0x01);	 
			...
			for(ty=0;ty<bmp.pic_w_l;ty++)
				{
					...
					((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR=((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR&0x00ff)|(ReadValue&0xff00));	
					...
					((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR=((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR&0x00ff)|(ReadValue<<8));
					GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0004));;
					GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0004));;                          
				}
			}	
...
char display_picture(char *filename)
{
  ...
  if((bmp.pic_head[0]=='B')&&(bmp.pic_head[1]=='M'))
  {
	...
	LCD_WR_REG(0x0052,(320-bmp.pic_w_l)/2);
	LCD_WR_REG(0x0053,(320-bmp.pic_w_l)/2+bmp.pic_w_l-1);

	LCD_WR_REG(0x0050,(240-bmp.pic_h_l)/2);
	LCD_WR_REG(0x0051,(240-bmp.pic_h_l)/2+bmp.pic_h_l-1);
	Lcd_WR_Start();
	}
...
char display_partation_picture(char *filename,u16 x0,u16 y0,u16 pic_x,u16 pic_y,u16 pic_L,u16 pic_H)
{
  ...
  if((bmp.pic_head[0]=='B')&&(bmp.pic_head[1]=='M'))
  {
	...
	Lcd_SetBox(x0,y0,pic_L,pic_H,0,0);
...
char display_button_picture(char *filename)
{
  ...
  if((bmp.pic_head[0]=='B')&&(bmp.pic_head[1]=='M'))
  {
	...
	for (ty = 0; ty < 240; ty++)
	{
	    ...
	    for(tx=0;tx<320;tx++)
		{  
           if(((239-ty)>(55+50+(240-50*2-55*2)+50-1))||((239-ty)<55))
		      continue;
			  
           if((tx>(25+125+(320-125*2-25*2)+125-1))||(tx<25))
		      continue;

           if(((239-ty)>(55+50-1))&&((239-ty)<55+50+(240-50*2-55*2)))
		      continue;

           if((tx>(25+125-2))&&(tx<(25+125+(320-125*2-25*2)-2)))
		      continue;
           
		   if(tx==25){ 
		       Lcd_SetCursor(25,239-ty);	
			   Lcd_WR_Start();
  			   GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0002));;
	           GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0001));; 
		   }

		   if(tx==25+125+(320-125*2-25*2)){ 
		       Lcd_SetCursor(25+125+(320-125*2-25*2),239-ty);	
			   Lcd_WR_Start();
  			   GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0002));;
	           GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0001));; 
		   }

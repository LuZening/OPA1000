...
void startSCCB(void)
{
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR = ((uint16_t)0x0800);     
    OV7670_delay_us(500);

    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR = ((uint16_t)0x1000);	   
    OV7670_delay_us(500);
 
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR = ((uint16_t)0x0800);
    OV7670_delay_us(500);

    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR = ((uint16_t)0x1000);	 
    OV7670_delay_us(500);
...
unsigned char SCCBwriteByte(unsigned char m_data)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR = ((uint16_t)0x1000);	
	OV7670_delay_us(100);
	if(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR&(((uint16_t)0x0800))){tem=0;}   
	else {tem=1;}   
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR = ((uint16_t)0x1000);	
	OV7670_delay_us(500);	
